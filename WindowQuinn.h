        ...
        #ifndef __WINDOW__140290418702800
        #define __WINDOW__140290418702800
            ...
            public:
                 ...
                 */
                 bool transform(float *x, float *dest = NULL) {
                    ...
                    // shift
                    memcpy(queue, queue + 9, sizeof(float) * 66);
                    head -= 9;
